      ...
      <div className="flex border-l-2 border-gray-700 bg-gray-800 h-[calc(100vh-70px)] font-sans">
        ...
        <div className="flex-1 p-4 ">
          ...
          <ul className=" text-black p-5 font-medium bg-white my-2">
            <ul className="text-lg bg-yellow-400 w-44  p-1">Degree</ul>
            <li className="py-1 pl-3">{"" ? "" : "MCA"}</li>
            <ul className="text-lg bg-yellow-400 w-44  p-1">Institution</ul>
            <li className="py-1 pl-3">{"" ? "" : "University of Delhi"}</li>
            <ul className="text-lg bg-yellow-400  w-44 p-1">Graduation Date</ul>
            <li className="py-1 pl-3">{"" ? "" : "2022"}</li>
            <ul className="text-lg bg-yellow-400 w-44 p-1">Location</ul>
          ...
          {/* Eduction details */}
          <ul className=" text-black p-5 font-medium bg-white my-2">
            <ul className="text-lg bg-yellow-400 w-44  p-1">Job Title</ul>
            <li className="py-1 pl-3">{"" ? "" : "MCA"}</li>
            <ul className="text-lg bg-yellow-400 w-44  p-1">Company Name</ul>
            <li className="py-1 pl-3">{"" ? "" : "Enigmatix"}</li>
            <ul className="text-lg bg-yellow-400 w-44 w- p-1">Start Date</ul>
            <li className="py-1 pl-3">{"" ? "" : "2022"}</li>
            <ul className="text-lg bg-yellow-400 w-44  p-1">Location</ul>
            <li className="py-1 pl-3">{"" ? "" : "Punjab"}</li>
          </ul>
