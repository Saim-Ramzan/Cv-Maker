      ...
      <div
        ...
        <ul className='lg:flex lg:gap-x-8 max-lg:space-y-2'>
          <li className='max-lg:border-b max-lg:py-3'>
            <NavLink to={"/home"}
              className={({isActive}) =>
               `hover:text-[#007bff]  block font-bold text-[15px] ${isActive ? "text-[#007bff]" : "text-gray-600"}`}>Home</NavLink>
          </li>
          <li className='max-lg:border-b max-lg:py-3'>
            <NavLink to={"/templates"}
             className={({isActive}) =>
               `hover:text-[#007bff]  block font-bold text-[15px] ${isActive ? "text-[#007bff]" : "text-gray-600"}`}>Templates</NavLink>
          </li>
          <li className='max-lg:border-b max-lg:py-3'>
          <NavLink to={"/favorites"}
              className={({isActive}) =>
               `hover:text-[#007bff]  block font-bold text-[15px] ${isActive ? "text-[#007bff]" : "text-gray-600"}`}>Favorites</NavLink>
          </li>
        </ul>
